...
public class ManualSearches {
    ...
    public void manualDFS(Node<int[][]> initNode, Node<int[][]> target) {
    ...
    public void manualTDS(Node<int[][]> initNode, Node<int[][]> targetNode) {
    ...
    public void manualNIPS(Node<int[][]> initState, Node<int[][]> targetState) {
    ...
    public void manualMMS(Node<int[][]> initState, Node<int[][]> targetState) {
        long startTime = System.currentTimeMillis();
        CommonMethods methods = new CommonMethods();
        List<Node<int[][]>> visitedNodes = new ArrayList<>();
        Comparator<Node<int[][]>> comparator = new Comparator<Node<int[][]>>() {
